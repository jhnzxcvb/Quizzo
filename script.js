  ...
  exit_btn.onclick = () => {
    ...
    location.replace("./student_home.php");
  };
  ...
  quit_quiz.onclick = () => {
    location.replace("./student_hom.php"); //reload the current window
  };
  ...
  leaderBoard.onclick = () => {
    ...
    databse.ref("Users/").on("value", function (snapshot) {
      snapshot.forEach(function (childSnapshot) {
        ...
        if (childSnapshot.hasChild("Basic_info/username")) {
          // console.log(childData.Basic_info.user_name);
          usernname = childData.Basic_info.usernname;
        }
